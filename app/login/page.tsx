...
const S = `
  ...
  .auth-hero-sub {
    ...
    font-weight: 300; line-height: 1.75; max-width: 380px;
    margin-bottom: 40px;
  }
  ...
  .feature-icon {
    ...
    background: rgba(255,92,26,0.15); border: 1px solid rgba(255,92,26,0.25);
    display: flex; align-items: center; justify-content: center;
    flex-shrink: 0;
  }
  .feature-title {
    font-family: 'Syne', sans-serif; font-weight: 700;
    font-size: 14px; color: white; margin-bottom: 3px;
  }
  ...
  .form-title {
    ...
    letter-spacing: -1px; color: #0F0F0F;
    margin-bottom: 8px;
  }
  ...
  .google-btn:hover { border-color: #0F0F0F; background: white; box-shadow: 0 2px 12px rgba(0,0,0,0.08); }
  ...
  .field-label {
    ...
    color: #0F0F0F; margin-bottom: 7px;
  }
  .field-wrap {
    display: flex; align-items: center; gap: 10px;
    background: white; border: 1.5px solid #E8E6E1;
  ...
  .forgot-link {
    font-family: 'Syne', sans-serif; font-size: 13px; font-weight: 600;
    color: #FF5C1A; text-decoration: none;
  }
