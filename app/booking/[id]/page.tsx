...
const S = `
  ...
  .price-prefix {
    ...
    font-family: 'Syne', sans-serif; font-weight: 700; color: #0F0F0F; font-size: 15px;
    pointer-events: none;
  }
  ...
  .success-btn:hover { background: #FF7A40; }
  .success-btn-sec {
    display: block; width: 100%; background: transparent; color: #6B6B6B;
    font-family: 'Syne', sans-serif; font-weight: 600; font-size: 14px;
    border: 1.5px solid #E8E6E1; border-radius: 12px; padding: 12px;
    text-decoration: none; cursor: pointer; transition: all 0.2s;
  }
  .success-btn-sec:hover { background: #F5F4F1; color: #0F0F0F; }
          ...
          <div className="success-overlay">
            <div className="success-modal">
              ...
              <p className="success-sub">
                ...
                They typically respond within {worker.responseTime}. You&apos;ll get a notification once they accept.
              </p>
          ...
          <div className="book-card">
            ...
            <div className="book-section">
              ...
              <div className="field" style={{ marginBottom: 0 }}>
                ...
                <p className="price-note">Standard rate is {worker.currency}{worker.price}/hr. Leave blank to negotiate directly.</p>
              </div>
            </div>
            ...
            <div className="book-section">
              ...
              <div className="field" style={{ marginBottom: 0 }}>
                ...
                {errors.time && <p className="error-msg" style={{ marginBottom: 8 }}>{errors.time}</p>}
          ...
          <div className="book-sidebar">
            <div className="worker-summary">
              ...
              <div className="ws-row">
                <span className="ws-row-label"><MapPin size={14} />Location</span>
                <span className="ws-row-val">{worker.location}</span>
              </div>
              <div className="ws-row">
                <span className="ws-row-label"><Clock size={14} />Response time</span>
                <span className="ws-row-val">{worker.responseTime}</span>
              </div>
              <div className="ws-divider" />
              <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
                <div>
                  <p className="ws-price-big">{worker.currency}{worker.price}</p>
                  <p className="ws-price-note">per hour</p>
                </div>
                <div style={{ textAlign: 'right' }}>
                  <p style={{ fontSize: 12, color: '#6B6B6B' }}>Est. total</p>
                  <p style={{ fontFamily: 'Syne, sans-serif', fontWeight: 700, fontSize: 16, color: '#0F0F0F' }}>{worker.currency}{totalEst}</p>
                </div>
              </div>
            </div>
            ...
            <div className="order-summary">
              ...
              <div className="os-row"><span>Service</span><span>{worker.skill}</span></div>
              <div className="os-row"><span>Date</span><span>{date || '—'}</span></div>
              <div className="os-row"><span>Time</span><span>{selectedTime || '—'}</span></div>
              <div className="os-row"><span>Rate</span><span>{worker.currency}{worker.price}/hr</span></div>
              <div className="os-row total"><span>Estimated total</span><span>{worker.currency}{totalEst}</span></div>
              <p className="os-note">Final price agreed directly with worker. No payment charged upfront.</p>
            </div>
            ...
            <div className="submit-card">
              ...
              <div className="submit-trust">
                <AlertCircle size={13} color="#AFAFAF" />
                No payment charged until job is confirmed
              </div>
            </div>
          </div>
        </div>
